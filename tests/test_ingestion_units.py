...
def test_empty_document_preserves_existing_chunks(monkeypatch):
    # Empty extraction is not proof that an existing document should be erased.
    # Explicit deletion remains available through the admin endpoint / CLI.
    import asyncio
